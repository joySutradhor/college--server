        ...
        <div className='grid md:grid-cols-3 gap-5 md:mx-20 md:my-12'>

            {
                allCollege?.map(college => <div
                    ...
                    <figure><img src="/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg" alt="university image" /></figure>
                    <div className="card-body">
                        ...
                        <Link to={`/addmission/${college._id}`} ><button className="btn btn-primary btn-sm">Apply Now</button></Link>
                        </div>
                    </div>
                </div>)
            }
